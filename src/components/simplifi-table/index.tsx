...
import { Box, SxProps, useTheme, IconButton, Typography, Theme } from '@mui/material';
...
export default function SimplifiTable({ rows, columns, nextToken, pageSize = 10, loading, sx = {}, loadMore, onRowClick }: Props) {
