...
export default function ChatNavItem({ selected, collapse, conversation, onCloseMobile, clickConversation }: Props) {
  const { user } = useMockedUser();

  const mdUp = useResponsive('up', 'md');

  const { group, displayName, displayText, participants, hasOnlineInGroup } =
    useGetNavItem({
      conversation,
